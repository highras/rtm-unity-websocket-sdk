...
class Histories : Main.ITestCase
{
    ...
    static void GetP2PMessageInSync(RTMClient client, long peerUid, int count)
    {
        ...
        while (count > 0)
        {
            ...
            client.GetP2PMessage(
                (int count, long lastCursorId, long beginMsec, long endMsec, List<HistoryMessage> messages,
                    int errorCode) =>
                {
                    if (errorCode != com.fpnn.ErrorCode.FPNN_EC_OK)
                    {
                    ...
                    lastId = lastCursorId;        
                }, peerUid, true, maxCount, begin, end, lastId);
        }
    ...
    static void GetGroupMessageInSync(RTMClient client, long groupId, int count)
    {
        ...
        while (count > 0)
        {
            ...
            client.GetGroupMessage((int count, long lastCursorId, long beginMsec, long endMsec, List<HistoryMessage> messages, int errorCode) =>
            {
                ...
                lastId = lastCursorId;               
            }, groupId, true, maxCount, begin, end, lastId);
        }
    ...
    static void GetRoomMessageInSync(RTMClient client, long roomId, int count)
    {
        ...
        while (count > 0)
        {
            ...
            client.GetRoomMessage((int count, long lastCursorId, long beginMsec, long endMsec,
                List<HistoryMessage> messages, int errorCode) =>
            {
                if (errorCode != com.fpnn.ErrorCode.FPNN_EC_OK)
                {
                    StringBuilder sb = new StringBuilder();
                ...
                lastId = lastCursorId;                
            }, roomId, true, maxCount, begin, end, lastId);
        }
    ...
    static void GetBroadcastMessageInSync(RTMClient client, int count)
    {
        ...
        while (count > 0)
        {
            ...
            client.GetBroadcastMessage((int count, long lastCursorId, long beginMsec, long endMsec, List<HistoryMessage> messages, int errorCode) =>
            {
                ...
                lastId = lastCursorId;     
            }, true, maxCount, begin, end, lastId);
        }
    ...
    static void GetGroupChatInSync(RTMClient client, long groupId, int count)
    {
        ...
        while (count > 0)
        {
            ...
            client.GetGroupChat((int count, long lastCursorId, long beginMsec, long endMsec,
                List<HistoryMessage> messages, int errorCode) =>
            {
                if (errorCode != com.fpnn.ErrorCode.FPNN_EC_OK)
                {
    ...
    static void GetRoomChatInSync(RTMClient client, long roomId, int count)
    {
        ...
        while (count > 0)
        {
            ...
            client.GetRoomChat((int count, long lastCursorId, long beginMsec, long endMsec,
                List<HistoryMessage> messages, int errorCode) =>
            {
                if (errorCode != com.fpnn.ErrorCode.FPNN_EC_OK)
                {
    ...
    static void GetBroadcastChatInSync(RTMClient client, int count)
    {
        ...
        while (count > 0)
        {
            ...
            client.GetBroadcastChat((int count, long lastCursorId, long beginMsec, long endMsec,
                List<HistoryMessage> messages, int errorCode) =>
            {
                if (errorCode != com.fpnn.ErrorCode.FPNN_EC_OK)
                {
