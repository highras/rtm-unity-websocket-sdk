...
namespace com.fpnn.rtm
{
    ...
    public class RTMMasterProcessor : IRTMMasterProcessor
    {
        ...
        private readonly Dictionary<string, WebSocketQuestProcessDelegate> methodMap;
        ...
        public RTMMasterProcessor()
        {
            ...
            methodMap = new Dictionary<string, WebSocketQuestProcessDelegate>
            {
                { "ping", Ping },
    ...
    public void BeginCheckPingInterval()
        ...
        public WebSocketQuestProcessDelegate GetWebSocketQuestProcessDelegate(string method)
        {
            if (methodMap.TryGetValue(method, out WebSocketQuestProcessDelegate process))
            {
                return process;
            }
        ...
        public void SessionClosed(int ClosedByErrorCode)
        {
            ...
            RTMControlCenter.Instance.UnregisterSession(uid);
        }
        ...
        //----------------------[ RTM Operations ]-------------------//
        public Answer Ping(Quest quest)
        {
            AdvanceAnswer.WebSocketSendAnswer(new Answer(quest));
        ...
        public Answer Kickout(Quest quest)
        {
            bool closed = RTMControlCenter.Instance.GetClientStatus(uid) == RTMClient.ClientStatus.Closed;
            RTMControlCenter.Instance.CloseSession(uid);
        ...
        public Answer KickoutRoom(Quest quest)
        {
            if (questProcessor != null)
            {
        ...
        //----------------------[ RTM Messagess ]-------------------//
        public Answer PushMessage(Quest quest)
        {
            AdvanceAnswer.WebSocketSendAnswer(new Answer(quest));
        ...
        public Answer PushGroupMessage(Quest quest)
        {
            AdvanceAnswer.WebSocketSendAnswer(new Answer(quest));
        ...
        public Answer PushRoomMessage(Quest quest)
        {
            AdvanceAnswer.WebSocketSendAnswer(new Answer(quest));
        ...
        public Answer PushBroadcastMessage(Quest quest)
        {
            AdvanceAnswer.WebSocketSendAnswer(new Answer(quest));
